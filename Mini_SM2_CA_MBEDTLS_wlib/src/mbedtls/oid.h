...
//--Add by cong.peng 2017.05.09
#define MBEDTLS_OID_COUNTRY_CN					"\x81\x1c"		/* {cn(156)} */
#define MBEDTLS_OID_ORG_SCA						"\xcf\x55"		/* {State Cryptography Administration(10197)}*/
#define MBEDTLS_OID_SCA							MBEDTLS_OID_ISO_MEMBER_BODIES MBEDTLS_OID_COUNTRY_CN \
										MBEDTLS_OID_ORG_SCA /* {iso(1) member-body(2) cn(156) sca(10197)} */
#define MBEDTLS_OID_SCA_ALG						MBEDTLS_OID_SCA "\x01" /* algorithms(1) */
//--End Add
...
//--Add by cong.peng 2017.05.09
/* sm2 OBJECT IDENTIFIER ::= {
 *   iso(1) member-body(2) cn(156) sca(10197) alg(1) 301 } */
#define MBEDTLS_OID_EC_GRP_SM2		        MBEDTLS_OID_SCA_ALG "\x82\x2d"
//--End add
...
//--Add by cong.peng 2017.05.09
/*
* SM2 signature identifiers, from XXXX
*/

/* sm2-with-sm3 OBJECT IDENTIFIER ::= {
*   iso(1) member-body(2) cn(156) sca(10197) algorithms(1)
*   sm2-with-sm3(501)} */
#define MBEDTLS_OID_SM2_SM3					MBEDTLS_OID_SCA_ALG "\x83\x75"

/* sm2-with-SHA1 OBJECT IDENTIFIER ::= {
*   iso(1) member-body(2) cn(156) sca(10197) algorithms(1)
*   sm2-with-SHA1(502)} */
#define MBEDTLS_OID_SM2_SHA1				MBEDTLS_OID_SCA_ALG "\x83\x76"

/* sm2-with-SHA256 OBJECT IDENTIFIER ::= {
*   iso(1) member-body(2) cn(156) sca(10197) algorithms(1)
*   sm2-with-SHA256(503)} */
#define MBEDTLS_OID_SM2_SHA256				MBEDTLS_OID_SCA_ALG "\x83\x77"

/* rsa-with-sm3 OBJECT IDENTIFIER ::= {
*   iso(1) member-body(2) cn(156) sca(10197) algorithms(1)
*   rsa-with-sm3(504)} */
#define MBEDTLS_OID_RSA_SM3					MBEDTLS_OID_SCA_ALG "\x83\x78"

/* rsa-with-SHA1 OBJECT IDENTIFIER ::= {
*   iso(1) member-body(2) cn(156) sca(10197) algorithms(1)
*   rsa-with-SHA1(505)} */
#define MBEDTLS_OID_RSA_SHA1				MBEDTLS_OID_SCA_ALG "\x83\x79"

/* rsa-with-SHA256 OBJECT IDENTIFIER ::= {
*   iso(1) member-body(2) cn(156) sca(10197) algorithms(1)
*   rsa-with-SHA256(506)} */
#define MBEDTLS_OID_RSA_SHA256				MBEDTLS_OID_SCA_ALG "\x83\x7a"
